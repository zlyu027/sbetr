...
implicit none
 ...
 type, public, extends(BiogeoCon_type) :: SummsPara_type
  ...
  ! Microbial parameters
    ...
    real(r8) :: mic_transp
    real(r8) :: decay_mic0
    real(r8) :: decay_mic1            ! added from rzacplsbetr_cmupdated        -zlyu
    real(r8) :: decay_enz
    real(r8) :: pmax_enz
    real(r8) :: ea_vmax_mic
    real(r8) :: ea_vmax_enz
...
contains
  ...
  class(SummsPara_type), intent(inout) :: this
  real(r8) :: half_life
  real(r8) :: rgas                        ! added from rzacplsbetr_cmupdated        -zlyu
  ...
  rgas = 8.31446_r8 ! universal gas constant (J/K/mol)                    ! added from rzacplsbetr_cmupdated        -zlyu
  ...
  ! Microbes
    ...
    this%yld_mic = 0.252307388_r8*6._r8          !0.8_r8       !-zlyu         ! Growth efficiency of microbes (g mic/g res)
    ...
    this%ref_vmax_enz           = 3.833835166_r8*365._r8*6._r8/year_sec     !*4.5_r8         ! *3._r8    !*4_r8     !-zlyu    ! Maximum rate of polymer degradation (1/second)
  ...
  ! Microbes
    ...
    !this%ref_vmax_mic           = 10.9343_r8*365._r8/year_sec     ! Maximum rate of monomer assimilation (1/second) 
  ...
  this%rf_l3s2_bgc           = 0.5_r8             !0.35_r8                  !   -zlyu, testing
  this%rf_s2s1_bgc           = 0.55_r8
  this%rf_s3s1_bgc           = 0.55_r8

  !following is based on century parameterization
  this%k_decay_lit1          = (/14.8_r8*3._r8,18.5_r8*3._r8/)/year_sec     !*2._r8      !(/14.8_r8,18.5_r8/)/year_sec    !1/second    !-zlyu
  this%k_decay_lit2          = (/3.9_r8*3._r8 ,4.9_r8*3._r8/) /year_sec     !*2._r8      !(/3.9_r8 ,4.9_r8/) /year_sec    !1/second    !-zlyu
  this%k_decay_lit3          = (/3.9_r8*3._r8 ,4.9_r8*3._r8/) /year_sec     !*2._r8      !(/3.9_r8 ,4.9_r8/) /year_sec    !1/second    !-zlyu
  ...
  this%k_decay_cwd           = 6.5_r8/year_sec                 ! 12.8_r8     !0.6_r8/year_sec                 !1/second             !-zlyu, get cwd turnover faster
